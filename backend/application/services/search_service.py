...
class SearchService:
    def __init__(self, scraper_port: ScraperPort, cache_port: CachePort, cache_ttl: int = 3600):
    ...
    async def search(self, request: SearchRequest) -> List[Route]:
        ...
        logger.info(f"Scraper Started: {request.departure_station} -> {request.arrival_station}")
